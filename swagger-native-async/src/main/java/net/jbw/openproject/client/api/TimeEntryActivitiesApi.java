...
public class TimeEntryActivitiesApi {
   ...
   */
  public CompletableFuture<TimeEntriesActivity> apiV3TimeEntriesActivitiesIdGet (Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
        return CompletableFuture.failedFuture(new ApiException(400, "Missing the required parameter 'id' when calling apiV3TimeEntriesActivitiesIdGet"));
    }
          ...
          if (localVarResponse.statusCode()/ 100 != 2) {
              ...
              try {
                  return CompletableFuture.completedFuture(
                      memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<TimeEntriesActivity>() {})
                  );
              } catch (IOException e) {
