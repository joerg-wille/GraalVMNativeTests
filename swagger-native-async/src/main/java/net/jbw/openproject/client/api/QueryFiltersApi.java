...
public class QueryFiltersApi {
   ...
   */
  public CompletableFuture<Void> apiV3QueriesFiltersIdGet (String id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
        return CompletableFuture.failedFuture(new ApiException(400, "Missing the required parameter 'id' when calling apiV3QueriesFiltersIdGet"));
    }
