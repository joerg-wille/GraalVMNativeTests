...
public class StatusesApiImpl implements StatusesApi {

    private ApiClient apiClient;

    public StatusesApiImpl() {
        this(null);
    }

    public StatusesApiImpl(ApiClient apiClient) {
    ...
    public void apiV3StatusesGet(Handler<AsyncResult<Void>> resultHandler) {
        ...
        String localVarPath = "/api/v3/statuses";
    ...
    public void apiV3StatusesIdGet(Integer id, Handler<AsyncResult<Void>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling apiV3StatusesIdGet"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/api/v3/statuses/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
