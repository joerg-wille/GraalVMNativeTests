...
public class PrioritiesApiImpl implements PrioritiesApi {

    private ApiClient apiClient;

    public PrioritiesApiImpl() {
        this(null);
    }

    public PrioritiesApiImpl(ApiClient apiClient) {
    ...
    public void apiV3PrioritiesGet(Handler<AsyncResult<Void>> resultHandler) {
        ...
        String localVarPath = "/api/v3/priorities";
    ...
    public void apiV3PrioritiesIdGet(Integer id, Handler<AsyncResult<Void>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling apiV3PrioritiesIdGet"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/api/v3/priorities/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
