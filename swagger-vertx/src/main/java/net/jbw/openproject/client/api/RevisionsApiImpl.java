...
public class RevisionsApiImpl implements RevisionsApi {

    private ApiClient apiClient;

    public RevisionsApiImpl() {
        this(null);
    }

    public RevisionsApiImpl(ApiClient apiClient) {
    ...
    public void apiV3RevisionsIdGet(Integer id, Handler<AsyncResult<Void>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling apiV3RevisionsIdGet"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/api/v3/revisions/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
