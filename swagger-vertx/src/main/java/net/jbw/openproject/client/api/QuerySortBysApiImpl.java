...
public class QuerySortBysApiImpl implements QuerySortBysApi {

    private ApiClient apiClient;

    public QuerySortBysApiImpl() {
        this(null);
    }

    public QuerySortBysApiImpl(ApiClient apiClient) {
    ...
    public void apiV3QueriesSortBysIdGet(String id, Handler<AsyncResult<Void>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling apiV3QueriesSortBysIdGet"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/api/v3/queries/sort_bys/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
