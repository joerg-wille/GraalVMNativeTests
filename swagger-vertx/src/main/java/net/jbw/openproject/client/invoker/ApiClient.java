...
import net.jbw.openproject.client.invoker.auth.Authentication;
import net.jbw.openproject.client.invoker.auth.HttpBasicAuth;
import net.jbw.openproject.client.invoker.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    protected WebClient buildWebClient(Vertx vertx, JsonObject config) {
        ...
        if (!config.containsKey("userAgent")) {
            config.put("userAgent", "OpenAPI-Generator/0.2.2-vertx/java");
        }
