...
public class QueryColumnsApiImpl implements QueryColumnsApi {

    private ApiClient apiClient;

    public QueryColumnsApiImpl() {
        this(null);
    }

    public QueryColumnsApiImpl(ApiClient apiClient) {
    ...
    public void apiV3QueriesColumnsIdGet(String id, Handler<AsyncResult<Void>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling apiV3QueriesColumnsIdGet"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/api/v3/queries/columns/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
