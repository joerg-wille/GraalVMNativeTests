...
public class RolesApiImpl implements RolesApi {
    ...
    public RolesApiImpl(ApiClient apiClient) {
    ...
    public void apiV3RolesIdGet(Integer id, Handler<AsyncResult<Void>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling apiV3RolesIdGet"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/api/v3/roles/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
