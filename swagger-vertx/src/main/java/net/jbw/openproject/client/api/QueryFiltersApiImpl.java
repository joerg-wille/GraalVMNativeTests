...
public class QueryFiltersApiImpl implements QueryFiltersApi {

    private ApiClient apiClient;

    public QueryFiltersApiImpl() {
        this(null);
    }

    public QueryFiltersApiImpl(ApiClient apiClient) {
    ...
    public void apiV3QueriesFiltersIdGet(String id, Handler<AsyncResult<Void>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling apiV3QueriesFiltersIdGet"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/api/v3/queries/filters/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
