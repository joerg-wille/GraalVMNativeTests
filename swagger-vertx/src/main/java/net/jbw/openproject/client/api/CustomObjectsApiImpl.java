...
public class CustomObjectsApiImpl implements CustomObjectsApi {

    private ApiClient apiClient;

    public CustomObjectsApiImpl() {
        this(null);
    }

    public CustomObjectsApiImpl(ApiClient apiClient) {
    ...
    public void apiV3CustomObjectsIdGet(Integer id, Handler<AsyncResult<Void>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling apiV3CustomObjectsIdGet"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/api/v3/custom_objects/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
