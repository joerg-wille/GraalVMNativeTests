...
public class QueryOperatorsApiImpl implements QueryOperatorsApi {

    private ApiClient apiClient;

    public QueryOperatorsApiImpl() {
        this(null);
    }

    public QueryOperatorsApiImpl(ApiClient apiClient) {
    ...
    public void apiV3QueriesOperatorsIdGet(String id, Handler<AsyncResult<Void>> resultHandler) {
        ...
        if (id == null) {
            resultHandler.handle(ApiException.fail(400, "Missing the required parameter 'id' when calling apiV3QueriesOperatorsIdGet"));
            return;
        }
        
        // create path and map variables
        String localVarPath = "/api/v3/queries/operators/{id}".replaceAll("\\{" + "id" + "\\}", id.toString());
