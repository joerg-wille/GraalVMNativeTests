...
public class VersionsApi {
  ...
  public Versions apiV3ProjectsProjectIdVersionsGet(Integer projectId) throws ApiException {
    ...
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling apiV3ProjectsProjectIdVersionsGet");
    }
    ...
    try {
      ...
      return memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<Versions>() {});
    } catch (IOException e) {
  ...
  public Version apiV3VersionsIdGet(Integer id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3VersionsIdGet");
    }
    ...
    try {
      ...
      return memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<Version>() {});
    } catch (IOException e) {
      throw new ApiException(e);
    } catch (InterruptedException e) {
      Thread.currentThread().interrupt();
