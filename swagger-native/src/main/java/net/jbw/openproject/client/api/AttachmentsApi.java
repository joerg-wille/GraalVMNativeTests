...
public class AttachmentsApi {
  ...
  public void apiV3AttachmentsIdDelete(Integer id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3AttachmentsIdDelete");
    }
  ...
  public void apiV3AttachmentsIdGet(Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3AttachmentsIdGet");
    }
  ...
  public void apiV3WorkPackagesIdAttachmentsGet(Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3WorkPackagesIdAttachmentsGet");
    }
  ...
  public void apiV3WorkPackagesIdAttachmentsPost(Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3WorkPackagesIdAttachmentsPost");
    }
