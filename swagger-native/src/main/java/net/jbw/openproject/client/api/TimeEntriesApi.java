...
public class TimeEntriesApi {
  ...
  public TimeEntries apiV3TimeEntriesGet(Integer offset, Integer pageSize, String filters) throws ApiException {
    ...
    try {
      ...
      return memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<TimeEntries>() {});
    } catch (IOException e) {
  ...
  public TimeEntry apiV3TimeEntriesIdGet(Integer id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3TimeEntriesIdGet");
    }
    ...
    try {
      ...
      return memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<TimeEntry>() {});
    } catch (IOException e) {
      throw new ApiException(e);
    } catch (InterruptedException e) {
      Thread.currentThread().interrupt();
   ...
   * @throws ApiException if fails to make API call
   */
  public void apiV3TimeEntriesPost(TimeEntryPost body, Integer offset, Integer pageSize, String filters, String sortBy) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling apiV3TimeEntriesPost");
    }
