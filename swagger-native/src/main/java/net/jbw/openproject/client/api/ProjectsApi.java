...
public class ProjectsApi {
  ...
  public Projects apiV3ProjectsGet(String filters) throws ApiException {
    ...
    try {
      ...
      return memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<Projects>() {});
    } catch (IOException e) {
  ...
  public Project apiV3ProjectsIdGet(Integer id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3ProjectsIdGet");
    }
  ...
  public void apiV3VersionsIdProjectsGet(Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3VersionsIdProjectsGet");
    }
