...
public class UsersApi {
  ...
  public Users apiV3UsersGet(Integer offset, Integer pageSize, String filters, String sortBy) throws ApiException {
    ...
    try {
      ...
      return memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<Users>() {});
    } catch (IOException e) {
  ...
  public void apiV3UsersIdDelete(Integer id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3UsersIdDelete");
    }
  ...
  public User apiV3UsersIdGet(String id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3UsersIdGet");
    }
  ...
  public void apiV3UsersIdLockDelete(Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3UsersIdLockDelete");
    }
  ...
  public void apiV3UsersIdLockPost(Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3UsersIdLockPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public void apiV3UsersIdPatch(Integer id, InlineObject5 body) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3UsersIdPatch");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public void apiV3UsersPost(InlineObject6 body) throws ApiException {
