...
public class RelationsApi {
  ...
  public void apiV3RelationsIdDelete(Integer id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3RelationsIdDelete");
    }
  ...
  public void apiV3RelationsIdFormPost(Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3RelationsIdFormPost");
    }
  ...
  public void apiV3RelationsIdGet(Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3RelationsIdGet");
    }
  ...
  public void apiV3RelationsIdPatch(Integer id) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3RelationsIdPatch");
    }
  ...
  public void apiV3RelationsSchemaTypeGet(String type) throws ApiException {
    ...
    if (type == null) {
      throw new ApiException(400, "Missing the required parameter 'type' when calling apiV3RelationsSchemaTypeGet");
    }
