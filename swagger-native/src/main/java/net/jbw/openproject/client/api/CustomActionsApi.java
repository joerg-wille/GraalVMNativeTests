...
public class CustomActionsApi {
   ...
   */
  public void apiV3CustomActionsCustomActionIdExecutePost(Integer customActionId, InlineObject1 body) throws ApiException {
    // verify the required parameter 'customActionId' is set
    if (customActionId == null) {
      throw new ApiException(400, "Missing the required parameter 'customActionId' when calling apiV3CustomActionsCustomActionIdExecutePost");
    }
  ...
  public void apiV3CustomActionsCustomActionIdGet(Integer customActionId) throws ApiException {
    // verify the required parameter 'customActionId' is set
    if (customActionId == null) {
      throw new ApiException(400, "Missing the required parameter 'customActionId' when calling apiV3CustomActionsCustomActionIdGet");
    }
