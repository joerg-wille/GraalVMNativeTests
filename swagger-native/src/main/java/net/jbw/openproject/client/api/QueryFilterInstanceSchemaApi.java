...
public class QueryFilterInstanceSchemaApi {
  ...
  public void apiV3ProjectsIdQueriesFilterInstanceSchemasGet(Integer id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling apiV3ProjectsIdQueriesFilterInstanceSchemasGet");
    }
  ...
  public void apiV3QueriesFilterInstanceSchemasIdentifierGet(String identifier) throws ApiException {
    ...
    if (identifier == null) {
      throw new ApiException(400, "Missing the required parameter 'identifier' when calling apiV3QueriesFilterInstanceSchemasIdentifierGet");
    }
