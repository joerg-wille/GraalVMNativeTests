...
public interface QueriesApi {
  ...
  Observable<Void> apiV3ProjectsIdQueriesDefaultGet(
  ...
  Observable<Void> apiV3ProjectsIdQueriesSchemaGet(
  ...
  Observable<Void> apiV3QueriesAvailableProjectsGet();
  ...
  Observable<Void> apiV3QueriesDefaultGet(
  ...
  Observable<Void> apiV3QueriesFormPost();
   ...
   */
  @GET("api/v3/queries")
  Observable<Void> apiV3QueriesGet(
  ...
  Observable<Void> apiV3QueriesIdDelete(
  ...
  Observable<Void> apiV3QueriesIdGet(
  ...
  Observable<Void> apiV3QueriesIdPatch(
  ...
  Observable<Void> apiV3QueriesIdStarPatch(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Observable<Void> apiV3QueriesIdUnstarPatch(
            @retrofit2.http.Path("id") Integer id            
  );
   ...
   */
  @POST("api/v3/queries")
  Observable<Void> apiV3QueriesPost();
  ...
  Observable<Void> apiV3QueriesSchemaGet();
