package net.jbw.openproject.client.invoker;
...
import net.jbw.openproject.client.invoker.auth.ApiKeyAuth;
import net.jbw.openproject.client.invoker.auth.HttpBasicAuth;
import net.jbw.openproject.client.invoker.auth.OAuth;
import net.jbw.openproject.client.invoker.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
	...
	public void createDefaultAdapter() {
		...
		adapterBuilder = new Retrofit.Builder().baseUrl(baseUrl)
	...
	/**
	 * Helper method to configure authorization endpoint of the first oauth found in
