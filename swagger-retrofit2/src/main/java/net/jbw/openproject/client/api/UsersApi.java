...
public interface UsersApi {
  ...
  Call<Void> apiV3UsersIdLockDelete(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Call<Void> apiV3UsersIdLockPost(
            @retrofit2.http.Path("id") Integer id            
  );
