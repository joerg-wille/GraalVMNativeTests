...
public interface WorkPackagesApi {
  ...
  Call<Void> apiV3ProjectsIdWorkPackagesFormPost(
  ...
  Call<WorkPackages> apiV3ProjectsIdWorkPackagesGet(
  ...
  Call<WorkPackage> apiV3ProjectsIdWorkPackagesPost(
  ...
  Call<Void> apiV3ProjectsProjectIdWorkPackagesAvailableAssigneesGet(
  ...
  Call<Void> apiV3ProjectsProjectIdWorkPackagesAvailableResponsiblesGet(
            @retrofit2.http.Path("project_id") Integer projectId            
  );
  ...
  Call<Void> apiV3WorkPackagesFormPost();
  ...
  Call<WorkPackages> apiV3WorkPackagesGet(
  ...
  Call<Void> apiV3WorkPackagesIdActivitiesGet(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Call<Void> apiV3WorkPackagesIdActivitiesPost(
  ...
  Call<Void> apiV3WorkPackagesIdAvailableProjectsGet(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Call<Void> apiV3WorkPackagesIdAvailableRelationCandidatesGet(
  ...
  Call<Void> apiV3WorkPackagesIdAvailableWatchersGet(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Call<Void> apiV3WorkPackagesIdDelete(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Call<Void> apiV3WorkPackagesIdFormPost(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Call<WorkPackage> apiV3WorkPackagesIdGet(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Call<WorkPackage> apiV3WorkPackagesIdPatch(
  ...
  Call<Void> apiV3WorkPackagesIdRelationsFormPost(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Call<Void> apiV3WorkPackagesIdRevisionsGet(
            @retrofit2.http.Path("id") Integer id            
  );
  ...
  Call<WorkPackage> apiV3WorkPackagesPost(
  ...
  Call<Void> apiV3WorkPackagesSchemasGet(
  ...
  Call<Void> apiV3WorkPackagesSchemasIdentifierGet(
  ...
  Call<Void> apiV3WorkPackagesWorkPackageIdRelationsGet(
  ...
  Call<Void> apiV3WorkPackagesWorkPackageIdRelationsPost(
            @retrofit2.http.Path("work_package_id") Integer workPackageId            
  );
  ...
  Call<Void> apiV3WorkPackagesWorkPackageIdWatchersGet(
            @retrofit2.http.Path("work_package_id") Integer workPackageId            
  );
  ...
  Call<Void> apiV3WorkPackagesWorkPackageIdWatchersIdDelete(
  ...
  Call<Void> apiV3WorkPackagesWorkPackageIdWatchersPost(
